                ...
                <div className="overflow-hidden">
                  <table className="min-w-full">
                    ...
                    <tbody>
                      ...
                      {data.map( index => ({ codigoCartaoBeneficiario, documentoBenefiario, documentoTitular, contrato, anoReferencia }) => (
                        <tr key="{item} className="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
