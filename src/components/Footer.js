const Footer = () => {
    return <footer className="p-4 bg-white sm:p-6 dark:bg-gray-900">

    <hr className="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8" />
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://unimed.com.br/" className="hover:underline">Unimed Leste Fluminense</a>. All Rights Reserved.
        </span>
        <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <a href="https://www.facebook.com/unimedlestefluminense/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
            ...
            <a href="https://www.instagram.com/unimedlestefluminenseoficial/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
            ...
            <a href="https://mobile.twitter.com/hashtag/unimedlestefluminense?src=hash" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
