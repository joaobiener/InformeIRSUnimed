        ...
        <div className="container mt-10  ml-60  px-4">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="w-60 text-align">
              ...
              <input placeholder='CPF/CPNJ'  {...register("CPF")} type="text" id="small-input" className="block p-2 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
              <div className='mt-6'>
