      ...
      <>
        ...
        <div class="container mx-auto mt-5">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div class="w-60 text-align">
              
              <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="grid-state">
                Ano de Referência
              </label>
              <div className="relative">
                ...
                <select {...register("AnoReferencia")} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  id="anoRef-select">
                  {data.map(({ id, anoReferencia, mes }) => (
                    <option key={anoReferencia} value={anoReferencia}>
                      {anoReferencia}
                    </option>
                  ))}
                </select>
              ...
              <input  {...register("CPF")} type="text" id="small-input" className="block p-2 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
              <div className='mt-6'>
